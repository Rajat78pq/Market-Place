...
export class LayoutComponent implements OnInit, AfterViewInit {
  ...
  constructor(private eventService: EventService, private store: Store<{ layout: { DATA_LAYOUT: string } }>, @Inject(PLATFORM_ID) private platformId: Object, private stores: Store<RootReducerState>) {
